...
import 'package:nobuzz_app/core/htpp/http_exception.dart';
import 'package:nobuzz_app/core/htpp/http_response.dart';
import 'package:nobuzz_app/core/log/log.dart';
...
class HttpDio implements IHttp {
  ...
  _logInfo(String path, String methodo,
      {Map<String, dynamic>? queryParamters, dynamic data}) {
    log.d(
        'METHOD: $methodo \nPATH: ${_dio.options.baseUrl}$path \nQUERYPARAMTERS: $queryParamters \nDATA: $data');
  }

  _logResponse(String path, String methodo,
